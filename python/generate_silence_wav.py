...
def main():
    ...
    out_path = os.path.join(Pre_PATH,'input/train/audio/silence/')

    if not os.path.exists(out_path):
        os.mkdir(out_path)
    reduce_PATH = os.path.join(out_path,'*')
    os.system("rm -rf *.wav")
    # os.system("rm -rf '%s'") %(reduce_PATH)
    #     os.mkdirs('../input/train/audio/silence')
    # os.system('rm -rf ../input/train/audio/silence/*')

    path = os.path.join(Pre_PATH,'input/train/audio/_background_noise_/')
