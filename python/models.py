...
def build_arm_rnn_model(
    ...
    # bug run_cell no registered kernels
...
def build_arm_lstm_model_size_s(input_shape):
    return build_arm_rnn_model(input_shape, rnn_cell = CuDNNLSTM, rnn_cell_num_units = 118)

def build_arm_lstm_model_size_m(input_shape):
    return build_arm_rnn_model(input_shape, rnn_cell = CuDNNLSTM, rnn_cell_num_units = 214)

def build_arm_lstm_model_size_l(input_shape):
    return build_arm_rnn_model(input_shape, rnn_cell = CuDNNLSTM, rnn_cell_num_units = 344)

def build_arm_lstm_model_size_xl(input_shape):
    return build_arm_rnn_model(input_shape, rnn_cell = CuDNNLSTM, rnn_cell_num_units = 512)

def build_arm_gru_model_size_s(input_shape):
    return build_arm_rnn_model(input_shape, rnn_cell = CuDNNGRU, rnn_cell_num_units = 154)

def build_arm_gru_model_size_m(input_shape):
    return build_arm_rnn_model(input_shape, rnn_cell = CuDNNGRU, rnn_cell_num_units = 250)

def build_arm_gru_model_size_l(input_shape):
    return build_arm_rnn_model(input_shape, rnn_cell = CuDNNGRU, rnn_cell_num_units = 400)

def build_arm_gru_model_size_xl(input_shape):
    #bug 
    return build_arm_rnn_model(input_shape, rnn_cell = CuDNNGRU, rnn_cell_num_units = 616)

def build_arm_crnn_model(
        input_shape,
        cnn_layer_num_filters=48, cnn_layer_kernel_size= (10, 4), cnn_layer_strides=(2,2),
        num_rnn_layers = 2, rnn_cell = CuDNNGRU,
...
def build_arm_crnn_model_size_s(input_shape):
    return build_arm_crnn_model(
        input_shape,
        cnn_layer_num_filters=48, cnn_layer_kernel_size= (10, 4), cnn_layer_strides=(2,2),
        rnn_cell = CuDNNGRU, rnn_layer1_num_cells = 60, rnn_layer2_num_cells = 60,
        fully_connected_layer_num_units = 84
        )
...
def build_arm_crnn_model_size_m(input_shape):
    return build_arm_crnn_model(
        ...
        rnn_cell = CuDNNGRU, rnn_layer1_num_cells = 76, rnn_layer2_num_cells = 76,
...
def build_arm_crnn_model_size_l(input_shape):
    return build_arm_crnn_model(
        ...
        rnn_cell = CuDNNGRU, rnn_layer1_num_cells = 136, rnn_layer2_num_cells = 136,
...
def build_arm_crnn_model_size_xl(input_shape):
    return build_arm_crnn_model(
        ...
        rnn_cell = CuDNNGRU, rnn_layer1_num_cells = 168, rnn_layer2_num_cells = 168,
...
def build_my_crnn_model_size_1(input_shape):
    return build_arm_crnn_model(
        ...
        rnn_cell = CuDNNGRU, rnn_layer1_num_cells = 128, rnn_layer2_num_cells = 128,
        fully_connected_layer_num_units = 256
        )
...
def build_arm_dscnn_model_size_t(input_shape):
    return build_arm_dscnn_model(
        ...
        opt = Adam, initial_learning_rate = 0.005,
        drop_out_rate = 0.2
        )
...
def build_join_model_size_t(
    ...
    rnn_model = CuDNNGRU(units = 256)(inputs)
